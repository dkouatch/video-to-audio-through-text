...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        # default='./configs/vt2a_mlm_alibi_mix_large_uni_encodec_gemma_vgg_stage_2.yaml'
        default='./configs/vt2a_mlm_alibi_mix_large_uni_encodec_gemma_vgg.yaml'
    )
    ...
    prompter = Prompter("gemma")
    tokenizer = GemmaTokenizer.from_pretrained("../v2cap/pretrained_mdls/gemma_2b/")
    ...
    # GT audio captions, Uncomment for using GT captions
        ...
        for line in tqdm(f.readlines()):
            ...
            with torch.no_grad():
                with torch.autocast(device_type='cuda', dtype=torch.bfloat16):
                    ...
                    out = model.generate_audio(x, cfg_coef=5, mask_temperature=25.5)
                    end = time.time()
