...
# for file_path in tqdm(glob.glob(audioset_clip_visual_path + "*/*")):
    ...
    split_file_to_path["Y" + file_name] = file_path
    # print(file_name)
...
audioset_caption_path = "/global/homes/x/xiuliu/audioset_{}_audio_caption.json".format(split)
...
v2a_instruction = []
for file_name, audio_cap in tqdm(caption.items()):
    ...
    v2a_instruction.append(
        {
            ...
            "dataset": "audioset",
            "output": audio_cap.split("Audio caption: ")[-1],
