...
def train(
    ...
    # wandb params
    wandb_project: str = "v2a_llm_gemma",
    wandb_run_name: str = "",
    ...
    if '../../../pretrained_mdls/gemma/' not in base_model:
    ...
    model = GemmaForCausalLM.from_pretrained(
        pretrained_model_name_or_path="/pscratch/sd/x/xiuliu/ltu/pretrained_mdls/gemma_2b/",
        load_in_8bit=False,
        #torch_dtype=torch.float16,
        device_map=device_map,
    )

    tokenizer = GemmaTokenizer.from_pretrained("/pscratch/sd/x/xiuliu/ltu/pretrained_mdls/gemma_2b/")
