...
class GemmaModel(GemmaPreTrainedModel):
    ...
    def __init__(self, config: GemmaConfig, load_embedding=True):
        ...
        if load_embedding:
            ...
            # if save_embedding:
            #     torch.save(self.embed_tokens.weight.data, "/pscratch/sd/x/xiuliu/ltu/pretrained_mdls/gemma_2b/word_embeds.pth")
            #     exit(0)
    ...
    def forward(
        ...
        return BaseModelOutputWithPast(
            last_hidden_state=hidden_states[:, video_length:, :],
...
class GemmaForCausalLM(GemmaPreTrainedModel):
    ...
    def forward(
        ...
        # print("HHH", logits.shape, labels.shape)
        logits = logits.float()
        loss = None
    ...
    def prepare_inputs_for_generation(
        self, input_ids, video_input, past_key_values=None, attention_mask=None, inputs_embeds=None, cache_position=None, **kwargs
    ):
        ...
        if inputs_embeds is not None and past_key_values is None:
            ...
            model_inputs = {"input_ids": input_ids.contiguous(), "video_input": video_input}
